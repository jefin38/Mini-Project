...
(9, 'JavaScript', 'Inside which HTML element do we put the JavaScript?', 'What is the correct JavaScript syntax to change the content of the HTML element below?\r\n\r\n\r\n<p id="demo">This is a demonstration.</p>', 'Where is the correct place to insert a JavaScript?', 'What is the correct syntax for referring to an external script called "xxx.js"?', 'The JavaScript file must save as .js . True or False?'),
...
(101, 'Bindhu', 'G', 'Kottayam', 'Female', '1999-02-03', 'Kerala', '1234', 23456784),
(103, 'Rajesh', 'S', 'Kozhikkode', 'Male', '1998-01-03', 'Kerala', '1234', 23578894),
(104, 'Koshy', 'Scaria', 'Kochi', 'Male', '2000-02-03', 'Kerala', '1234', 9878845896),
(106, 'Remya', 'T K', 'Kollam', 'Female', '1996-03-05', 'Kerala', '1234', 2595555759);
...
('anil@gmail.com', 'Anil James'),
('thomas@gmail.com', 'Thomas M D');
...
INSERT INTO `result` (`RsID`, `Eno`, `ExamID`, `Marks`) VALUES
