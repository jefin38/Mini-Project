	...
	<div class="row">
		<div class="col-md-12">
			<form name="register" action="" method="POST" onsubmit="return validateForm()">
				<fieldset>
					<legend>
						<h3 style="padding-top: 25px;">Student Registration  </h3>
					</legend>
...
Male</label>&nbsp&nbsp&nbsp&nbsp
...
Female</label>
					...
					<div class="control-group form-group">
						<div class="controls">
							...
							<input type="password" class="form-control" name="pass" id="pass" maxlength="30"> <span style="color: #ff0000;">*Make strong passwords <br> *Remember your Passwords</span>
							<p class="help-block"></p>
						</div>
					</div>

					<button type="submit" name="submit" class="btn btn-primary">Register</button> &nbsp&nbsp
