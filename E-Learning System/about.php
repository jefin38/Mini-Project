...
<br><br>
        ...
        <p>The <strong>LearnOnline</strong> Website (web based application) is useful for the
...
In this application, student can attend his\her missed classes from e-learn.</p> 
        ...
        <div class="row">
        <div class="col-lg-12">
      <br><br><br><br><br><br><br><br>  <h2 class="page-header">Our Alumni</h2><br><br><br><br> 
        </div>
        ...
        <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">Our Student's</h2><br><br>
        </div>
